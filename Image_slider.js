...

{
   ...
   image.id = "1";
   image.style.backgroundImage = "URL('/IMG-20220803-WA0001.jpg')";
...
function box2()
{
   ...
   let image = document.querySelector(".image");
   image.id = "2";
   image.style.backgroundImage = "URL('/IMG_20220810_215435.jpg')";
   image.style.backgroundSize = "contain";
...
function box3()
{
   ...
   let image = document.querySelector(".image");
   image.id = "3";
   image.style.backgroundImage = "URL('/IMG_20230618_194040.jpg')";
   image.style.backgroundSize = "contain";
...
function box4()
{
   ...
   let image = document.querySelector(".image");
   image.id = "4";
   image.style.backgroundImage = "URL('/IMG_20230717_182936.jpg')";
   image.style.backgroundSize = "contain";
...
function box5()
{
   ...
   let image = document.querySelector(".image");
   image.id = "5";
   image.style.backgroundImage = "URL('/1658919488146.jpg')";
   image.style.backgroundSize = "contain";
...
function box6()
{
   ...
   let image = document.querySelector(".image");
   image.id = "6";
   image.style.backgroundImage = "URL('/1658919121219.jpg')";
   image.style.backgroundSize = "contain";
...
function box7()
{
   ...
   let image = document.querySelector(".image");
   image.id = "7";
   image.style.backgroundImage = "URL('/IMG_20240201_102857.jpg')";
   image.style.backgroundSize = "contain";
